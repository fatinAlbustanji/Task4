...
#convert a string
with open('./SpeechResult.mp3','wb')as audio_file:
    res=tts.synthesize('Hello Smart Method World, I am Fatin',accept='audio/mp3', voice='en-US_AllisonV3Voice').get_result()
